...
const ErrorCard = ({ error }) => {
    ...
    return (
        <li className="my-8 border border-t-4 border-[#2f4f4f] text-red-600">
            <div className="flex gap-4 border-b-2 px-2 py-4 md:px-8">
                ...
                <h2 className=" max-w-[245px] break-words text-xl text-[#2f4f4f] sm:max-w-none">
                    {error.message}
                </h2>
            </div>
            <div className="flex flex-col space-y-2 px-2 py-4 md:pl-20 ">
