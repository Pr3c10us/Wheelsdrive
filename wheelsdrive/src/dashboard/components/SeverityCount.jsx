...
const SeverityCount = ({ blocker, critical, major, minor, info }) => {
    return (
        <ul className="mb-1 flex items-center md:justify-center space-x-2 text-sm text-black sm:mb-0 md:flex">
            <li className="flex">
                <div
                    className={
                        blocker > 0
